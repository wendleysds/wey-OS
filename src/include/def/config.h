...
#define KERNEL_VIRT_END  0x100000000
...
#define KERNEL_VIRTUAL_SIZE (KERNEL_VIRT_END - KERNEL_VIRT_BASE)

#define KERNEL_RESERVED_SIZE \
	(KERNEL_HIGHMEM_SIZE + KERNEL_FIXEDMAP_SIZE + \
	KERNEL_NONLINEAR_SIZE + KERNEL_VMEMMAP_SIZE)

#define KERNEL_DIRECTMAP_SIZE \
	(KERNEL_VIRTUAL_SIZE - KERNEL_RESERVED_SIZE)
...
#define KERNEL_NONLINEAR_START (KERNEL_HIGHMEM_END + 1)
...
#define PROC_USER_STACK_SIZE KiB(8)
#define PROC_KERNEL_STACK_SIZE KiB(8)
...
#define TTY_BUFFER_LDISC_SIZE 512
