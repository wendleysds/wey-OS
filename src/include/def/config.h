...
#define HEAP_SIZE_BYTES 1024 * 1024 * 40 // 40 MiB
#define HEAP_BLOCK_SIZE 4096

#define HEAP_PHYS_BASE 0x01000000
#define HEAP_PHYS_END  (unsigned int)HEAP_PHYS_BASE + HEAP_SIZE_BYTES

#define HEAP_VIRT_BASE 0xC2000000
#define HEAP_VIRT_END  (unsigned int)HEAP_VIRT_BASE + HEAP_SIZE_BYTES
...
#define HEAP_TABLE_VIRT_BASE \
	HEAP_VIRT_BASE - ((unsigned int)HEAP_TABLE_PHYS_END - (unsigned int)HEAP_TABLE_PHYS_BASE)

#define HEAP_TABLE_VIRT_END HEAP_TABLE_VIRT_BASE + (HEAP_SIZE_BYTES / HEAP_BLOCK_SIZE)

#define KERNEL_FB_VIRT_BASE 0xD0000000

#define KERNEL_STACK_PHYS_BASE 0x00200000
#define KERNEL_STACK_SIZE 1024 * 512 // KiB
#define KERNEL_STACK_PHYS_END KERNEL_STACK_PHYS_BASE + KERNEL_STACK_SIZE

#define KERNEL_STACK_VIRT_BASE 0xC1000000
#define KERNEL_STACK_VIRT_END KERNEL_STACK_VIRT_BASE + KERNEL_STACK_SIZE
