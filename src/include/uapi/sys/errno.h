...
#define ENOBUFS         105 // No buffer space available. This condition caused by lack of memory in the OS's buffers.
...
#define ENOTSUP         134 // Not supported parameter or optio
